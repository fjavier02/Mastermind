...
function verificacion() {
    ...
    if (numero_codeValidation[0] === numero_code[0]) { //verificando posicion 0
        ...
        if (numero_codeValidation[0] === numero_code[1]) {
            numero_correcto++;
        }else { // verificando position 2
            if (numero_codeValidation[0] === numero_code[2]) {
                numero_correcto++;
            }else { // verificando position 3
                if (numero_codeValidation[0] === numero_code[3]) {
                    numero_correcto++;
                }
            }
        }
    ...
    if (numero_codeValidation[1] === numero_code[1]) { //verificando posicion 0
        ...
        if (numero_codeValidation[1] === numero_code[0]) {
            numero_correcto++;
        }else { // verificando position 2
            if (numero_codeValidation[1] === numero_code[2]) {
                numero_correcto++;
            }else { // verificando position 3
                if (numero_codeValidation[1] === numero_code[3]) {
                    numero_correcto++;
                }
            }
        }
    ...
    if (numero_codeValidation[2] === numero_code[2]) { //verificando posicion 0
        ...
        if (numero_codeValidation[2] === numero_code[0]) {
            numero_correcto++;
        }else { // verificando position 2
            if (numero_codeValidation[2] === numero_code[1]) {
                numero_correcto++;
            }else { // verificando position 3
                if (numero_codeValidation[2] === numero_code[3]) {
                    numero_correcto++;
                }
            }
        }
    ...
    if (numero_codeValidation[3] === numero_code[3]) { //verificando posicion 0
        ...
        if (numero_codeValidation[3] === numero_code[0]) {
            numero_correcto++;
        }else { // verificando position 2
            if (numero_codeValidation[3] === numero_code[1]) {
                numero_correcto++;
            }else { // verificando position 3
                if (numero_codeValidation[3] === numero_code[2]) {
                    numero_correcto++;
                }
            }
        }
